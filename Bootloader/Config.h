...
#define APP1_FLASH      0x2000
#define APP2_FLASH      0x6000
...
#define RS485_CTR1      P2OUT |= BIT0;          //控制线置高，RS485发送状态
#define RS485_CTR0      P2OUT &= ~BIT0;         //控制线置低，RS485接收状态

#define LED1            P2OUT |= 0xFE;
#define LED0            P2OUT &= 0x01;
